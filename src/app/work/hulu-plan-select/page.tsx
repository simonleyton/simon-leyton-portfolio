...
export const metadata: Metadata = {
  ...
  description:
    "Redesigning the screen where people decide to subscribe: a three-way experiment on Hulu's plan picker that cut cart abandonment and lifted the Disney+ bundle.",
};
    ...
    >
      ...
      <div className="max-w-[1400px] mx-auto px-5 md:px-10">
        ...
        <div className="flex flex-col gap-16 md:gap-24">
          ...
          <div className="flex flex-col md:flex-row gap-10 lg:gap-20">
            <div className="flex-1">
              <p className="text-lg md:text-2xl leading-snug text-foreground max-w-[60ch]">
                ...
                decides whether to pay for it — and about half of the
                non-subscribers who reached it on mobile web were walking
                away right there. I led design on the
                experiment that rebuilt how plans are compared — and whose
                projected impact made it the largest win Hulu had to date.
              </p>
            </div>
          ...
          >
            <Prose>
              Plan Select sits second in Hulu&apos;s four-step sign-up funnel
              — welcome page, plan selection, account creation, billing — which
              makes it the gate to all downstream revenue. And roughly 50% of
              non-subscribers visiting on mobile web were abandoning their
              cart at exactly that step.
            </Prose>
            <Prose>
          ...
          <FlowStrip
            ...
            alt="Four phone screenshots in a row showing each step of the Hulu sign-up flow on mobile web"
          ...
          >
            <Prose>
              The bet: by presenting all plans in one view — including the
              Disney+ bundle as a first-class option — we would decrease
              abandonment, drive sign-up rate, lift bundle take rate, and end
          ...
          >
            <Prose>
              ...
              a drawer system, a tab bar — each a different theory of how people compare
              plans on a small screen. The strongest patterns became
          ...
          >
            <Prose>
              Treatment A was the control — the one-plan-at-a-time carousel
              already in production. Treatment B stacked every plan vertically
              ...
              comparison. The experiment ran July 2–12, 2021.
            </Prose>
          </SectionHeading>
          <FlowStrip
          ...
          <FlowStrip
            ...
            caption="The winning treatment in hand: side-by-side plans, stable detail area, persistent select."
            width={1305}
            height={665}
          />
